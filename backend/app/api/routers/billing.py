...
from app.models.domain import Tenant, User, PlanType
from app.schemas.billing import UpgradePlanRequest, PlanResponse, UpgradePlanResponse
from app.api.dependencies import require_tenant, superadmin_only
from app.core.plans import get_plan_limits, get_plan_features, PLAN_LIMITS
from app.core.flags import upgrade_flags
...
async def get_plan(
    ...
    result = await db.execute(select(func.count(User.id)).where(User.tenant_id == tenant.id))
