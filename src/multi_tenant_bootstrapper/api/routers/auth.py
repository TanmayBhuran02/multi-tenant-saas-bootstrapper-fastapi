"""Authentication router — login, register, and profile endpoints."""
...
from multi_tenant_bootstrapper.models.domain import User, UserRole
from multi_tenant_bootstrapper.schemas.auth import (
    LoginRequest, RegisterRequest, LoginResponse, UserResponse,
)
from multi_tenant_bootstrapper.core.security import create_access_token
from multi_tenant_bootstrapper.api.dependencies import get_current_user, require_tenant
